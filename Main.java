...
public class Main {
    ...
    public static void main(String[] args) throws ShipNotAvailableException, IllegalMoveException {
        ...
        ZeeslagBoard zeeslagBoard = new ZeeslagBoard(7, 7);

        // Create Moves object
        Moves moves = new Moves(zeeslagBoard);

        // Place a Patrouilleschip ship at (4, 4)
        Ship patrouilleschip = new Ship(Ship.PATROUILLESCHIP);
        moves.placeShip(patrouilleschip, 2, 2, true);
        // Hit the ship at (4, 4)
        moves.placeHit(2, 2);
